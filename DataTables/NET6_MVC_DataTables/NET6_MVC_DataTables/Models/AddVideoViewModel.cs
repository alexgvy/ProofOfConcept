...
{
    public class AddVideoViewModel : CreateOrUpdateBaseViewModel
    {
        ...
        //[Display(Name = "Is this video part of a series?")]
        //[Required(ErrorMessage = "The '{0}' field is required.")]
        //public YES_NO IsVideoSeries { get; set; } = new YES_NO();
        ...
        //[Required(ErrorMessage = "The Video File field is required.")]
        ...
        public bool DisplayAddVideoFileButton { get; set; }
